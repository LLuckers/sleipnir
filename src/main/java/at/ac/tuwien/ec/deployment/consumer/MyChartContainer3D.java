...
public class MyChartContainer3D<S extends Solution<?>> {
  ...
  public MyChartContainer3D(String name) {
    this(name, 0);
  }

  public MyChartContainer3D(String name, int delay) {
    this.name = name;
    this.delay = delay;
  ...
  public void addFrontChart(int objective1, int objective2, String objective1Title, String objective2Title) {
    try {

      String o1Title = "Objective " + objective1;
      if(objective1Title != null && objective1Title != ""){
        o1Title = objective1Title;
      }
      String o2Title = "Objective " + objective2;
      if(objective2Title != null && objective2Title != ""){
        o2Title = objective2Title;
      }
  ...
  public void updateFrontCharts(List<S> solutionList, int counter, String problemName) {
    for (Map.Entry<String, XYChart> entry : this.charts.entrySet()) {
      ...
      entry.getValue().addSeries(problemName + " - Front." + counter,
       this.getSolutionsForObjective(solutionList, objective1),
  ...
  public MyChartContainer3D setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public MyChartContainer3D setDelay(int delay) {
    this.delay = delay;
    return this;
  }
